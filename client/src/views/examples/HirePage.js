          ...
          <Container>
            <Row>
              <Col className="ml-auto mr-auto text-center" md="8">
                <h2 className="title">Why Hire zone4code's Tech Talent?
                </h2>
                ...
                <h5 className="description">
                  <ul>
                    ...
                    <li>
                      Our Software Engineering, UX Design, and Data Science Immersives build best-in-class tech talent for your dream tech team.                  </li>
                  </ul>
                </h5>
              </Col>
            </Row>
